            ...
            <div className="sm:w-9/12 w-11/12 mx-auto grid sm:grid-cols-3 text-center">
                ...
                <div className="my-5 text-left">
                    ...
                    <div className="font-semibold text-gray-300">
                        <p>Hart Care</p>
                        <p>Dhanmondi, Pahthapath</p>
                        <p>Dhaka, Bangladesh</p>
                    </div>
                </div>
            </div>
            <div className="sm:w-9/12 w-11/12 text-gray-400 mt-5 mx-auto text-center">
                <p>Developed by <a className="font-semibold" target="_blank" rel="noreferrer" href="https://github.com/mdibuhossain">Ayman Oli</a></p>
                <hr className="border-gray-600 my-2" />
                <p>&copy; 2023 All rights reserved by Heart Care</p>
            </div>
        </div>
    );
};
